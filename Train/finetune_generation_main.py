from finetune_generation_utils import *
...
def main():
    ...
    # load model
    model = load_model(args, 'data/compress_generation/all_node_types.pkl')
    
    # training loop
    if args.do_train:
        cum_train_loss, num_steps, num_train = 0, 0, len(train_data['text_inputs']['input_ids'])
